...
BLOG_AUTHOR = "Maxime Liquet"  # (translatable)
BLOG_TITLE = "Here and there"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://maximlt.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://maximlt.github.io/"
BLOG_EMAIL = "maximeliquet@free.fr"
BLOG_DESCRIPTION = "Bio/Blog"  # (translatable)
